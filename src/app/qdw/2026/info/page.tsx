...
export default function QDW2026Info() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formDataToSubmit.append(
      process.env.NEXT_PUBLIC_ENTRY_FIRST_NAME || '',
      formData.firstName,
    )
    formDataToSubmit.append(
      process.env.NEXT_PUBLIC_ENTRY_LAST_NAME || '',
      formData.lastName,
    )
    formDataToSubmit.append(
      process.env.NEXT_PUBLIC_ENTRY_EMAIL || '',
      formData.email,
    )
    formDataToSubmit.append(
      process.env.NEXT_PUBLIC_ENTRY_DESIGNATION || '',
      formData.designation,
    )
    formDataToSubmit.append(
      process.env.NEXT_PUBLIC_ENTRY_LOCATION || '',
      formData.location,
    )
  ...
  const sponsors = [
    ...
    { name: 'Nanoacademic', logo: '/images/nanoacademic.png', tier: 'gold' },
    {
      ...
      logo: '/images/quantum_machine.png',
      tier: 'silver',
    },
    ...
    {
      name: 'Quantum Design',
      logo: '/images/quantum-design.png',
      tier: 'silver',
    },
  ...
  const speakers = [
    ...
    },
    {
      ...
      bio: 'Michael Hatridge is an Associate Professor at Yale University specializing in superconducting quantum circuits, quantum amplification, and quantum measurement.',
    },
    {
      name: 'Ani Nersisyan',
      affiliation: 'Google',
    ...
    },
    {
      ...
      bio: 'Hugh Carson is a Senior Applied Scientist at the Amazon Center for Quantum Computing, working on Palace, a large-scale 3D finite-element electromagnetics solver for superconducting quantum devices.',
    },
    {
      name: 'Greg Peairs',
      affiliation: 'Amazon',
      image: '/images/Greg_Peairs.png',
      bio: 'Greg Peairs is a Research Scientist at the Amazon Center for Quantum Computing, developing DeviceLayout.jl for schematic-driven, scalable design of superconducting quantum integrated circuits.',
    },
    {
      name: 'Ebrahim Forati',
      affiliation: 'Google Quantum AI',
      image: '/images/Ebrahim_Forati.jpg',
      bio: 'Ebrahim Forati is a researcher at Google Quantum AI specializing in numerical electromagnetic modeling for large-scale superconducting quantum processors.',
    },
    {
      name: 'Prasad Sarangapani',
      affiliation: 'Rigetti',
      image: '/images/Prasad_Sarangapani.jpg',
      bio: 'Prasad Sarangapani is a Lead Quantum Engineer at Rigetti Computing working on loss characterization and calibration in multi-die superconducting qubit architectures.',
    },
    {
      name: 'Helge Gehring',
      affiliation: 'Google Quantum AI',
      image: '/images/Helge_Gehring.jpg',
      bio: 'Helge Gehring is a researcher at Google Quantum AI focused on open-source tooling for large-scale quantum device layout, centered on the KLayout programmatic API.',
    },
    {
      name: 'Simon Bilodeau',
      affiliation: 'Google Quantum AI',
      image: '/images/Simon_Bilodeau.png',
      bio: 'Simon Bilodeau is a hardware engineer at Google Quantum AI working on open-source design and simulation tooling, including OpenCascade/GMSH-based meshing of device geometries.',
    },
    {
      name: 'Bianca Hanly',
      affiliation: 'Google Quantum AI',
      image: '/images/Bianca_Hanly.jpg',
      bio: 'Bianca Hanly is a Quantum Device Design Engineer at Google Quantum AI working on the KLayout verification engine for DRC and Layout-vs-Schematic checks on quantum processors.',
    },
    {
      name: 'Wes Roberts',
      affiliation: 'Alice & Bob',
      image: '/images/Wes_Roberts.png',
      bio: 'Wes Roberts is a Quantum Hardware and Physics Specialist at Alice & Bob working on the design of noise-biased cat qubits for fault-tolerant quantum computing.',
    },
    {
      name: 'Chris Anderson',
      affiliation: 'UCLA',
      image: '/images/Chris_Anderson.jpg',
      bio: 'Chris Anderson is a professor at UCLA working on the simulation and design of semiconductor spin qubits and their integration with superconducting systems.',
    },
    {
      name: 'Alex LeBon',
      affiliation: 'Quantum Design Oxford',
      image: '/images/Alex_LeBon.png',
      bio: 'Alex LeBon is a Sales Engineer at Quantum Design Oxford specializing in dilution refrigeration and cryogenic experimental workflows for superconducting qubit experiments.',
    },
    {
      name: 'Joseph Glick',
      affiliation: 'QBlox',
      image: '/images/Qblox_JosephGlick_002.jpeg',
      bio: 'Joseph Glick is a Quantum Application Scientist at Qblox working on scalable quantum control electronics and real-time quantum error correction interfaces.',
    },
    {
      name: 'Fadime Bekmambetova',
      affiliation: 'Nanoacademic',
      image: '/images/fadime.png',
      bio: 'Fadime Bekmambetova is a Research Scientist at Nanoacademic Technologies working on multi-physics TCAD modeling of circuit QED with semiconductor quantum dots.',
    },
  ]
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              ...
              >
                <h1
                  ...
                  style={{
                    textShadow:
                      '0 0 20px rgba(147, 51, 234, 0.4), 0 0 40px rgba(147, 51, 234, 0.2), 0 2px 4px rgba(0,0,0,0.5)',
                  }}
                >
                ...
                <p className="text-lg sm:text-xl text-white/90 mb-8 drop-shadow-lg">
                  Cohen Room and Mong Auditorium, Engineering VI Building at
                  UCLA
                </p>
          ...
          <div className="max-w-7xl mx-auto w-full">
            ...
            >
              ...
              <p className="text-gray-900 text-lg leading-relaxed">
                The Quantum Device Workshop is designed to teach advanced
                undergraduates and graduate students the art of designing
                quantum devices. QDW 2026 features a 4-day hands-on workshop on
                how to effectively design, simulate and work with
                superconducting qubits. We will cover theory and simulation
                techniques, best practices, and general constraints for
                designing superconducting devices. We offer an introductory
                track and an advanced track so that people of all skill levels
                can gain something from this event. We offer in-person lectures,
                workshops, and panel sessions. In 2026 we will also offer a
                Poster session, a design project and a career perspective
                session. Attendees can register for an online-only option for
                the lectures and workshop sessions.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            >
              ...
              <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 md:p-10 border border-white/10">
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-4">
                  QDW 2026 will be hosted in person at the{' '}
                  <strong className="text-white">
                    Cohen Room and Mong Auditorium in the Engineering VI
                    Building at UCLA
                  </strong>
                  , 404 Westwood Plaza, Los Angeles, CA 90095.
                </p>
                <p className="text-gray-400">
                  Online sessions will also be available via Zoom for remote
                  participants.
                </p>
                <a
              ...
              <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 md:p-10 border border-white/10">
                ...
                <p className="text-gray-400">
                  In-person and online options. Schedule details for QDW 2026
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border-l-2 border-green-500/50 pl-4">
                      ...
                      <ul className="text-gray-300 space-y-1 text-sm">
                        ...
                        <li>
                          • ABCD Formalism, Quantum Error Correction and Large
                          Scale Simulation
                        </li>
                  ...
                  <div className="space-y-6">
                    <div className="border-l-2 border-purple-500/50 pl-4">
                      <h4 className="text-lg font-semibold text-purple-400 mb-2">
                        Day 1: Advanced simulation and large scale design
                      </h4>
                      <ul className="text-gray-300 space-y-1 text-sm">
                        <li>
                          • Advanced simulation techniques and large scale
                    ...
                    <div className="border-l-2 border-purple-500/50 pl-4">
                      <h4 className="text-lg font-semibold text-purple-400 mb-2">
                        Day 2: Circuit analysis and designing for control
                      </h4>
                      <ul className="text-gray-300 space-y-1 text-sm">
                        <li>
                          • Circuit analysis methods and designing quantum
                          devices for control
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="border-l-2 border-purple-500/50 pl-4">
                      <h4 className="text-lg font-semibold text-purple-400 mb-2">
                        Day 3: Error correction and AI in design
                      </h4>
                      <ul className="text-gray-300 space-y-1 text-sm">
                        <li>
                          • Quantum error correction and AI-driven approaches to
                          device design
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="border-l-2 border-purple-500/50 pl-4">
                      <h4 className="text-lg font-semibold text-purple-400 mb-2">
                        Day 4: Design for unconventional and hybrid systems
                      </h4>
                      <ul className="text-gray-300 space-y-1 text-sm">
                        <li>
                          • Designing for unconventional and hybrid quantum
                          systems
                        </li>
                      </ul>
                    </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:border-purple-500/50 transition-all duration-300">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Engage with industry experts and researchers in interactive
                    panel sessions covering career perspectives, emerging
                    technologies, and the future of quantum computing.
                  </p>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:border-amber-500/50 transition-all duration-300">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Unwind and network with fellow attendees, speakers, and
                    sponsors during our casual evening social events. Build
                    connections over refreshments in a relaxed atmosphere.
                  </p>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:border-green-500/50 transition-all duration-300">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Apply your knowledge hands-on! Work in teams to design and
                    simulate a quantum device, receiving feedback from mentors
                    and presenting your work on the final day.
                  </p>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:border-blue-500/50 transition-all duration-300">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Present your research and projects to the quantum community.
                    Exchange ideas, receive feedback, and discover cutting-edge
                    work from researchers across institutions. Posters should be
                    no more than 36 × 48 inches; both vertical and horizontal
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="relative flex items-start">
              ...
              <button
                onClick={() =>
                  setSpeakerPage((prev) =>
                    prev === 0 ? Math.ceil(speakers.length / 4) - 1 : prev - 1,
                  )
                }
                          ...
                          {speakers
                            ...
                            .map((speaker, index) => (
                              ...
                              >
                                ...
                                <p className="text-white font-semibold mt-3 text-center text-sm sm:text-base">
                                  {speaker.name}
                                </p>
                                {speaker.affiliation && (
                                ...
                                {/* Hover tooltip */}
                                <div
                                  className={`absolute top-full mt-2 w-56 sm:w-64 p-3 sm:p-4 bg-gray-900 rounded-xl shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 border border-purple-500/30 ${index % 2 === 0 ? 'left-0 sm:left-1/2 sm:-translate-x-1/2' : 'right-0 sm:left-1/2 sm:-translate-x-1/2'}`}
                                >
              ...
              <button
                onClick={() =>
                  setSpeakerPage((prev) =>
                    prev === Math.ceil(speakers.length / 4) - 1 ? 0 : prev + 1,
                  )
                }
                className="flex-shrink-0 z-20 w-10 h-10 md:w-12 md:h-12 rounded-full bg-purple-600/30 border border-purple-500/50 flex items-center justify-center hover:bg-purple-600/50 transition-all duration-300 mt-12 md:mt-16"
        ...
        <section className="py-16 bg-gradient-to-br from-gray-50 to-gray-100 border-t border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center justify-center gap-3 mb-8">
              ...
              <button
                onClick={() => {
                  setShowAllSponsors(true)
                  setIsSponsorsScrolling(false)
                }}
                className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-200 ${
                  showAllSponsors
                    ? 'bg-gray-800 text-white shadow'
          ...
          {showAllSponsors ? (
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex flex-wrap justify-center gap-6">
                {sponsors.map((sponsor, index) => (
                  ...
                  >
                    <div
                      className={`relative w-full flex-1 min-h-0${sponsor.name === 'qolab' ? ' p-3' : ''}`}
                    >
                      <Image
                        src={sponsor.logo}
                        alt={sponsor.name}
                    ...
                    <span className="text-xs text-gray-500 font-medium text-center px-1 w-full truncate shrink-0">
                      {sponsor.name}
                    </span>
                  </div>
                ))}
            ...
            <div className="w-full">
              ...
              >
                ...
                {/* Scrolling container */}
                <div
                  className={`flex ${isSponsorsScrolling && !reducedMotion ? 'animate-scroll-left' : ''}`}
                >
                  {/* First set */}
                  {sponsors.map((sponsor, index) => (
                    <div
        ...
        <section className="py-16 bg-gradient-to-br from-white to-gray-50 border-t border-gray-200">
          ...
          <div className="w-full">
            ...
            >
              ...
              <div
                className={`flex ${isAcademicScrolling && !reducedMotion ? 'animate-scroll-right' : ''}`}
              >
                {/* First set */}
