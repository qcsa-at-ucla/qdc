...
const advancedSchedule: TimeSlot[] = [
  ...
  },
  {
    ...
    days: [
      ...
      { title: 'Taylor Patti', type: 'talk', company: 'NVIDIA', talkTitle: 'GPU Simulation and AI for the Design of Quantum Devices and Protocols', abstract: `Designing quantum devices, and figuring out how to beste-defined quantum dots in silicon and germanium have shown great potential as an alternative solid state-based platform for scalable quantum computing systems. The potential of combining semiconductor qubits with superconducting elements, whether passive elements such as resonators, or superconducting qubits, has been explored recently in a few different contexts and is an area with plenty of room for further exploration, particularly as semiconductor qubits continue to mature rapidly. The aim of this talk is to educate the audience on the state of the art in simulation of spin qubits and give some examples of how these simulations can be used to aid in the design coupled super-semi hybrid syst operate them, can be an unintuitive and time-consuming process. GPU simulations and AI assisted design can combat these challenges, greatly accelerating the parameter-to-output timeline and proposing data-driven device and control parameters. In this talk, we introduce these concepts and overview various such implementations.` },
      { title: 'Announcement of textbook project (starts at 1:50 PM instead of the usual 1:30 PM)', type: 'lecture', company: 'USC', speaker: 'Eli Levenson-Falk', talkTitle: '', abstract: `` },
    ],
  },
  {
    time: '2:15 – 3:00 PM',
