...
export default function Header() {
  return (
    <header
      className="
        relative w-full flex items-center justify-center overflow-hidden pt-16
        min-h-[75svh] sm:min-h-screen
      "
    >
      {/* Background Image */}
      ...
      {/* Content Container */}
      <div className="relative z-20 flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-20 md:py-24 max-w-7xl mx-auto">
        {/* Title */}
        <motion.h1
          ...
          className="
            font-bold text-white text-center mb-6 px-2 leading-tight
            text-3xl
            sm:text-4xl
            md:text-6xl
            lg:text-6xl
        ...
        <motion.p
          ...
          className="
            text-white text-center max-w-5xl mb-8 leading-relaxed px-2
            text-base
            sm:text-xl
            md:text-2xl
            lg:text-3xl
        ...
        >
          <Link
            href="/join"
            className="
              inline-block bg-gradient-to-r from-indigo-500 to-purple-500
              ...
              outline-none focus:ring-4 focus:ring-indigo-300/40
            "
